...
namespace glslUtility {
    ...
    shaders_t loadShaders(const char* vert_path, const char* geom_path,
        ...
        if (!compiled) { std::cout << "Vertex shader not compiled." << std::endl; }
        ...
        if (!compiled) { std::cout << "Fragment shader not compiled." << std::endl; }
    ...
    void attachAndLinkProgram(GLuint program, shaders_t shaders) {
        ...
        if (!linked) { std::cout << "Program did not link." << std::endl; }
    ...
    GLuint createProgram(const char* vertexShaderPath,
        ...
        glslUtility::shaders_t shaders =
            glslUtility::loadShaders(vertexShaderPath, NULL, fragmentShaderPath);
    ...
    GLuint createProgram(const char* vertexShaderPath,
                         ...
                         const char* fragmentShaderPath,
                         const char* attributeLocations[], GLuint numberOfLocations) {
        glslUtility::shaders_t shaders = glslUtility::loadShaders(
